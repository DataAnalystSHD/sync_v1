...
- **Replace** — ลบข้อมูลปลายทางทั้งหมดก่อน แล้วเขียนใหม่ทั้งชุด (รองรับ Row Range)
- **Append** — เพิ่ม **เฉพาะแถวใหม่** ที่ยังไม่มีในปลายทาง โดยใช้ "จำนวนแถวที่ปลายทางมีอยู่แล้ว" เป็นตัวกำหนด → cron รันซ้ำกี่รอบก็ไม่เพิ่มข้อมูลซ้ำ (และยังถูกต้องแม้สลับจาก Replace มาเป็น Append) — Append จะ **ไม่สนใจ Row Range**
  - ข้อจำกัด: Append เป็นแบบ "ต่อท้าย" จึงคาดหวังว่าต้นทางเพิ่มแถวใหม่ที่**ท้ายตาราง** ถ้าไปแก้/แทรกแถวกลางๆ หรือลบแถวในปลายทางเอง อาจคลาดเคลื่อนได้
